                ...
                <div className="site-layout-background">
                    <Card className="dashbord-card" style={{ width: "100%" }}>
                        ...
                        <Typography.Paragraph style={{ margin: "0 0 10px" }}>
                            Next.js is a React framework that is used to build fast, high-performance, hybrid static and server side rendering web applications. Ant Design is a UI library that provides a lot of
                            pre-made React components like Button, DatePicker, DropDown, Drawer, etc, which can help you create beautiful and enterprise-class products.
